...
# Rutas para zonas disponibles
    ...
    path('zonas_disponiblles/obtener/<int:pk>/', views.Zonas_disponiblesDetail.as_view(), name='zonas_disponibles-detail'),
    path('zonas_disponibles/actulizar/<int:pk>/',views.Zonas_disponiblesUpdate.as_view(), name='zonas_disponibles-Update'),
    path('zonas_disponibles/eliminar/<int:pk>/',views.Zonas_disponiblesDelete.as_view(), name='zonas_disponibles-delete'),
